namespace Loupedeck.LitraGlowCCPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LitraGlowCCPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LitraGlowCCPlugin.Resources.Resource.txt`.
